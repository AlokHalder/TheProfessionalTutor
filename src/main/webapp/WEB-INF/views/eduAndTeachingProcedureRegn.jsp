...
<SCRIPT type="text/javascript">
            function addRow(tableID) {
                ...
                for(var i=0; i<colCount; i++) {
                    ...
                    newcell.innerform = table.rows[0].cells[i].innerform;
...
<body> 
    ...
    <form:form action="tutorEduAndTeachingProcRegistration">        
        ...
        <div class="cpart" style="margin-top: -20px;">
            ...
            <div class="loginInfoWrapper">
                <div class="fieldNameWrapper" style="margin-top:10px;">
                    ...
                    <div>
                    <td>
                        <form:select  path="ugQualifyingDegree" styleClass="registrationTextField" styleId="ugQualifyingDegreeId" onchange="javascript:return showHideOtherUgQualifyingDegree('ugQualifyingDegreeId')">
                            <%-- <%@ include file = "/jsp/library/ugcoursenames.jspf"  %> --%>
                            <%-- <form:optionsCollection name="tutorProfileRegistrationActionForm" path="listOfBasicUgCourses" label="labelName" value="labelValue"/> --%>
                            <form:option value="-1">-:Select Graduation:-</form:option>
                            <%
                        ...
                        <div id="otherUgQualifyingDegreeId" style="margin-top:10px; display: none" >
                           ...
                           <td> 
                            ...
                            <td>
                           <form:textarea path="otherUgQualifyingDegree" styleClass="registrationOtherTextField" title="Please specify other tutoring qualifying degree"/>
                ...
                <div class="fieldNameWrapper" style="margin-top:10px;">
                    ...
                    <div>
                        ...
                        <form:select  styleId="ugSpecializationId" styleClass="registrationTextField" path="ugSpecialization" onchange="javascript:return showHideOtherUgSpecialization('ugSpecializationId')"  title="Press Ctrl to select multiple teaching medium">

                            
                            <%-- <form:optionsCollection name="tutorProfileRegistrationActionForm" path="listOfSubjects" label="labelName" value="labelValue"/> --%>
                            <form:option value="-1">-:Select Specialization:-</form:option>
                            <%
                        ...
                        <div id="otherUgSpecializationId" style="margin-top:10px; display: none" >
                           ...
                           <form:textarea path="otherUgSpecialization"  styleClass="registrationOtherTextField" title="Please specify other specialization."/>
                ...
                <div class="fieldNameWrapper" style="margin-top:10px;" >
                    ...
                    <tr>
                    <td>
                    Select BORD or University
                    </td>
                    <td>
                    <div>
                        <form:select  path="ugBoardOrUniversity" styleClass="registrationTextField" styleId="ugBoardOrUniversityId" onchange="javascript:return showHideOtherUgBoardOrUniversity('ugBoardOrUniversityId')">
                            <%--   <%@ include file = "/jsp/library/boardUniversityOrInstitute.jspf"  %>
                                <form:optionsCollection name="tutorProfileRegistrationActionForm" path="listOfUniversityInstitute" label="labelName" value="labelValue"/>
                            --%>
...
<form:textarea path="otherUgBoardOrUniversity"  styleClass="registrationOtherTextField" title="Please specify other university/institute name"/>
                ...
                <div class="fieldNameWrapper" style="margin-top:10px;">
                   ...
                   <%--  <div>
                        <form:select  path="ugPassoutYear" styleClass="registrationTextField">
                            <%@ include file = "/WEB-INF/views/library/yearOfPassout.jspf"  %>
                        </form:select>
                ...
                <div class="fieldNameWrapper" style="margin-top:10px;">
                    ...
                    <tr><td>select your post grduation</td>
                    <td>
                    <div>

                        <form:select path="pgQualifyingDegree" styleClass="registrationTextField" styleId="pgQualifyingDegreeId" onchange="javascript:return showHideOtherPgQualifyingDegree('pgQualifyingDegreeId')">
                            <%-- <%@ include file = "/jsp/library/pgcoursenames.jspf"  %> 
                             <form:optionsCollection name="tutorProfileRegistrationActionForm" path="listOfBasicPgCourses" label="labelName" value="labelValue"/> --%>


                             <form:option value="-1">-:Select Post Graduation:-</form:option>
                            <%
                        ...
                        <div id="otherPgQualifyingDegreeId" style="margin-top:10px; display: none" >
                           ...
                           <form:textarea path="otherPgQualifyingDegree"  styleClass="registrationOtherTextField" title="Please specify other tutoring pg qualification"/>
                ...
                <div class="fieldNameWrapper" style="margin-top:10px;">
                    ...
                    <div>
                        ...
                        <form:select  styleId="pgSpecializationId" styleClass="registrationTextField" path="pgSpecialization" onchange="javascript:return showHideOtherPgSpecialization('pgSpecializationId')" >
                        ...
                        <div id="otherPgSpecializationId" style="margin-top:10px; display: none" >
                            ...
                            <form:textarea path="otherPgSpecialization"  styleClass="registrationOtherTextField" title="Please specify other tutoring pg qualification"/>
                            <span class="hint"><bean:message key="OTHER_UG_SPECIALISATION_HINTS"/><span class="hint-pointer">&nbsp;</span> </span>
                        </div>
                    </div>
                    <div class="clear"></div>
                ...
                <div class="fieldNameWrapper" style="margin-top:10px;">
                    ...
                    <tr>
                    <td>
                    select pgBoardOrUniversity
                    </td><td>
                    <div>
                        <form:select  path="pgBoardOrUniversity" styleClass="registrationTextField" styleId="pgBoardOrUniversityId" onchange="javascript:return showHideOtherPgBoardOrUniversity('pgBoardOrUniversityId')">
                        ...
                        <div id="otherPgBoardOrUniversityId" style="margin-top:10px;display: none">
                          <%--   <div class="labelName">
                           ...
                           <form:textarea path="otherPgBoardOrUniversity"  styleClass="registrationOtherTextField"  title="Please specify other university/institute name"/>
                            <span class="hint"><bean:message key="OTHER_BOARD_UNIVERSITY_HINTS"/><span class="hint-pointer">&nbsp;</span> </span>
                        </div>
                    </div>
                    <div class="clear"></div>
                ...
                <div class="fieldNameWrapper" style="margin-top:10px;">
                    ...
                    <div>
                        <form:select  path="pgPassoutYear" styleClass="registrationTextField">
                            <%@ include file = "/WEB-INF/views/library/yearOfPassout.jspf"  %>
                        </form:select>
                        <span class="hint"><bean:message key="YEAR_OF_PASSOUT_HINTS"/><span class="hint-pointer">&nbsp;</span> </span>
                    </div>
