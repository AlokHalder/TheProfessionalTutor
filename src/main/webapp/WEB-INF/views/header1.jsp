...
<!--    <span>|Help Desk:<strong style="color:#0968C9;">033-2442-5535</strong></span>-->
    <span>|Email:<a href="#">helpdesk@ptutors.in</a> </span>
    ...
    <div style="margin-left: 9px; margin-top: 6px; margin-right:0px; float: right; "> <a href="https://plus.google.com/b/115986616022593137690/115986616022593137690/about"><img src="image/google_plus.png " width="20px" height="20"></a></div>
    </div>
</div>
    </div>
</div>
...
<div style="float: right;"> <img src="images/contuct.gif" alt="Private Tutor Kolkata" width="200" height="93" /> </div>
...
<div id="mainBannerSection1" style="z-index: 1;">
    ...
    <select id="loctionId" name="tutorCityLocation" style="width:160px; border:1px solid #000000; color:#000000; font:13px/20px Arial, Helvetica, sans-serif; height:25px; margin:0 5px 0 10px;">
        ...
        <div style="overflow: hidden; height: 98px;"> 
            ...
            <div class="newsl"  >
                <ul id="ticker_02">
                    <li>The Professional Tutors is a unique platform which provides assistance and services to its members who are mainly students and tutors, by helping them find suitable tutors or students depending on their requirement. </li>
                    <li>ptutors.in is an excellent firm that provides wonderful opportunities for aspiring freshers. This firm also provides one of the best guidance and support a fresher needs to build on. </li>
                    <li>I owe a lot to the entire ptutors.in team which helped me to find the right job. ptutors.in is a beacon light for all job hunters. I personally feel that all Engineering graduates must give this test. It is definitely a career booster. </li>
                    <li>ptutors.in is an excellent platform for people who are looking for a head start in their career. ptutors.in helped me kick start my career with a great job in National Instruments. Thanks to their excellent guidance. </li>
                    <li>I would like to thank the ptutors.in team for their great efforts in helping build the careers of thousands of candidates like me. I currently work with Logica, once again thanks to ptutors.in. </li>
                    <li>I felt very happy hearing this news from you. I am very thankful to ptutors.in. Thank you very much ptutors.in team, you showed me a path to reach my dream. Once again thanking you very much.</li>
                    <li>I would like to extend my gratitude to ptutors.in for I would not have been where I am right now without their wonderful system. What make ptutors.in stand out from the crowd is the exams they conduct. </li>
                    <li>ptutors.in gives an excellent platform to freshers as it provides so many opportunities. I gave ptutors.in thrice and the third time got a good percentile so please have patience and prepare well. </li>
                    <li>Taking ptutors.in was the best thing i did in my college life. It is a highly regarded organization by recruiters and getting a decent score will make sure that you will end up in a very good job. </li>
                    <li>Though it was a brief association with ptutors.in but it will remain a memorable one. I will recommend ptutors.in to all of my friends and my juniors as it provides you an opportunity to prove yourself. </li> 
                </ul>
            </div>
