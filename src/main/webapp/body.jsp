...
.tutor_recently_join h2{
	background:url(../image/tutor_icon.png) no-repeat 0 0;
	line-height:37px;
	font-size:20px;
...
<div>
    ...
    <div class="left_green_small" ><h1 style=" color: #666;">Welcome to The Professional Tutors Family</h1></div>
    <div class="cpart">
        <div class="welcomeText" style="margin:0px 10px 0px 10px; width: 730px; color: #666;">
